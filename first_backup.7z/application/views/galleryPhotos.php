        ...
        <div class="content">
            <div class="container_12">
                <div class="grid_8">
                    ...
                    <div class="blog">
                        <p>
                            <?php if(empty($photos)){echo "لا يوجد صور بهذا الالبوم";} ?>
                            {photos}
                            <a class="fancybox-buttons" data-fancybox-group="button" href="<?php echo base_url(); ?>/assets/uploads/files/{photo}"><img src="<?php echo base_url(); ?>/assets/uploads/files/{photo}" alt="" class="galleryPhotos"/></a>
                            {/photos}
                        </p>
                    </div>
                </div>
